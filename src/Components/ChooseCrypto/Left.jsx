    ...
    return (
        <div className='flex relative z-20 lg:flex-row items-center gap-7 w-full justify-between flex-col-reverse'>
            <div className='text-white h-full gap-6 flex flex-col flex-grow'>
                <p className="w-full text-3xl font-[600] font-expletus md:text-[39px] flex justify-center lg:justify-start text-center lg:text-start">
                    Why You Choose Crypto Bulls ?
                </p>
                <p className='text-lg font-expletus text-[#FFFFFF] font-[400] text-[16px] flex flex-wrap md:text-center xl:text-start'>
