...
const ServicesBox = ({ items }) => {
    ...
    return (
        <div className='max-w-[327px] font-monst w-full h-[311px] text-[#FFFFFF] border-[1px] rounded-xl'>
            <div className='w-full h-fit p-4 justify-center bg-[#0396A699] rounded-t-xl border-b-[2px] items-center flex'>
                <p className='text-center font-expletus text-xl font-[600]'>{items.header}</p>
            </div>
            <div className='w-full font-monst flex mt-12 justify-center'>
